...
import Models
from pruningModels import PruneSSR
...
def train():
    ...
    imgs, imgs_mask = get_data(200) if '3D' in project_name else get_data(5, dims='2D')
    # data is in float64
    ...
    if 'SSR' in project_name:
        ...
        model = PruneSSR(model, data=(imgs, imgs_mask)).get_model()
